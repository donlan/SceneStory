...
public abstract class Sticker {
  ...
  public abstract Rect getRealBound();
  ...
  public boolean containsAll(float[] boundPoints){
      if(boundPoints!=null && boundPoints.length==8){
          Log.e("dong",boundPoints[0]+","+boundPoints[1]+"  "+boundPoints[2]+","+boundPoints[3]+"  "+boundPoints[4]+","+boundPoints[5]+"  "+boundPoints[6]+","+boundPoints[7]);
          if(contains(boundPoints[0],boundPoints[1])){
              return true;
          }
          if(contains(boundPoints[2],boundPoints[3])){
              return true;
          }
          if(contains(boundPoints[4],boundPoints[5])){
              return true;
          }
          if(contains(boundPoints[6],boundPoints[7])){
              return true;
          }
          return false;
      }
